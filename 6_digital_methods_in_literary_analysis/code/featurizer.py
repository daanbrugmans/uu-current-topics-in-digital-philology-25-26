...
class Featurizer:
    def __init__(self) -> None:
        ...
        #     "f_p_pos_base_adjective_ratio": [
        #         "JJ",
        #     ],
        #     "f_p_pos_comparative_adjective_ratio": [
        #         "JJR",
        #     ],
        #     "f_p_pos_superlative_adjective_ratio": [
        #         "JJS",
        #     ],
        #     "f_p_pos_base_adverb_ratio": [
        #         "RB",
        #     ],
        #     "f_p_pos_comparative_adverb_ratio": [
        #         "RBR",
        #     ],
        #     "f_p_pos_superlative_adverb_ratio": [
        #         "RBS",
        #     ],
        #     "f_p_pos_infinitive_verb_ratio": [
        #         "VB",
        #     ],
        #     "f_p_pos_present_tense_1st_2nd_person_verb_ratio": [
        #         "VBP",
        #     ],
        #     "f_p_pos_present_tense_3rd_person_verb_ratio": [
        #         "VBZ",
        #     ],
        #     "f_p_pos_past_tense_verb_ratio": [
        #         "VBD",
        #     ],
        #     "f_p_pos_present_participle_verb_ratio": [
        #         "VBG",
        #     ],
        #     "f_p_pos_past_participle_verb_ratio": [
        #         "VBN",
        #     ],
        #     "f_p_pos_modal_auxiliary_verb_ratio": [
        #         "MD",
        #     ],
        #     "f_p_pos_pronoun_ratio": ["PRP", "PRP$"],
        #     "f_p_pos_genetive_ratio": [
        #         "POS",
        #     ],
        #     "f_p_pos_interjection_ratio": [
        #         "UH",
        #     ],
        #     "f_p_pos_foreign_word_ratio": [
        #         "FW",
        #     ],
        #     "f_p_pos_numeral_ratio": [
        #         "CD",
        #     ],
    ...
    def get_sentence_wo_cap_at_start(self, sentences: list) -> int:
        """Count all sentences that do not start with a capital letter"""
    ...
    def get_sentence_lower_at_start(self, sentences: list) -> int:
        ...
        return sum(
            [1 for i in sentences if re.match(r"^[^A-z]*[a-z].*", i) is not None]
        )
    ...
    def get_a_an_error_count(self, document: str) -> int:
        ...
        return len(re.findall(r" an [^aeiou]", document)) + len(
            re.findall(r" a [aeiou]", document)
        )
    ...
    def get_he_she_ratio(self, tokens: list) -> float:
        ...
        return (tokens.count("he") + tokens.count("He") + 1) / (
    ...
    def get_short_word_count(
        self, tokens: list[str], short_word_max_length: int = 4
    ) -> int:
        ...
        """
        short_word_list = [
            word for word in tokens if len(word) <= short_word_max_length
        ]
    ...
    def get_alphabet_count(
        ...
        if not include_punctuation:
            text_char_alphabet = {
                char
                for char in text_char_alphabet
                if char not in list(string.punctuation)
            }

        if not include_digits:
            text_char_alphabet = {
                char for char in text_char_alphabet if char not in list(string.digits)
            }
    ...
    def get_word_without_vowels_count(
        self, tokens: list[str], include_y_as_vowel: bool = False
    ) -> int:
    ...
    # def get_pos_tag_ratios(
    #     self, tokens: list[str], pos_tag_groups: dict[str, list[str]]
    # ) -> dict[str, int]:
